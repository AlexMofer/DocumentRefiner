...
import io.github.alexmofer.documentskewcorrection.tensorflow.DocumentSkewDetectorTensorflowBuilder;

/**
 * ViewModel
 * Created by Alex on 2025/5/27.
 */
public class MainTensorflowViewModel extends ViewModel {
    ...
    private void handleImage(Context context, Uri uri) {
        ...
        ListenableFutureHelper.submit(() -> {
            ...
            final DocumentSkewDetector detector =
                    new DocumentSkewDetectorTensorflowBuilder(context)
